                            ...
                            <div class="cart-items">
                                ...
                                <div class="shopping-item">
                                    ...
                                    <ul class="shopping-list">
                                        @php $sum=0 @endphp
                                        @foreach(ShoppingCart::all() as $cartProducts)
                                            <li>
                                                <a href="javascript:void(0)" class="remove" title="Remove this item"><i class="lni lni-close"></i></a>
                                                <div class="cart-img-head">
                                                    <a class="cart-img" href="{{route('details', ['id'=>$cartProducts->id])}}"><img src="{{asset($cartProducts->feature_image)}}" alt="#"></a>
                                                </div>
                                                <div class="content">
                                                    <h4><a href="product-details.html">
                                                            {{$cartProducts->name}}</a></h4>
                                                    <p class="quantity">{{$cartProducts->qty}}x - <span class="amount">{{$cartProducts->total}}</span></p>
                                                </div>
                                            </li>
                                            @php $sum= $sum+ $cartProducts->total @endphp
                                        @endforeach
                                    </ul>
                                    <div class="bottom">
                                        <div class="total">
