                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <ul class="list-unstyled">
                                        ...
                                        <li class="text-muted">Delivery Address: {{$order->delivery_address}}</li>
                                        <li class="text-muted"><i class="ti ti-mobile"></i> {{$order->customer->mobile}}</li>
                                    </ul>
                                </div>
                                <div class="col-md-4">
                  ...
                  {{$order->payment_method == 1 ? 'Cash':'Online'}}</span></p>
                                ...
                                <div class="col-md-4 text-end">
                                    <ul class="list-unstyled">
                                        ...
                                        <li class="text-muted ms-3"><span class="text-black me-4">Total Amount: </span> {{$order->order_total}} TK</li>
                                    </ul>
                                </div>
                                <hr>
                                <div class="row">
